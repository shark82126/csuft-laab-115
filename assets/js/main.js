/* =========================================================
   ...
   学术动态、校友合作、纪念活动、活动日程、校友祝语墙。
   各板块文字均为依据学校公开资料整理的真实/权威信息，替换时只需改下方数组。
   ========================================================= */

/* ---------- 学校动态（依据学校公开报道整理） ---------- */
const schoolNews = [
  { tag:"纪念活动", title:"办学115周年高质量发展大会暨全球校友大会将启幕", desc:"学校诚挚邀请全球校友于 2026年11月8日 返校，共迎办学115周年、共谋高质量发展。", date:"2026-11-08", icon:"flag" },
...
const collegeNews = [
  { tag:"40周年", title:"风景园林学科恢复办学40周年系列纪念活动启动", desc:"围绕学术论坛、校友返校、成果展与院史文献征集开展系列活动。", date:"2026-09-01", icon:"flag" },
...
const alumni = [
  ...
  { name:"陈朝静", role:"土木工程学院校友分会杰出校友", dept:"土木工程 · 建筑工程", color:"#256d4f", bio:"中建四局安装公司董事长，土木工程领域校友企业家代表，长期深耕建筑安装与工程管理。", tags:["土木工程","建筑工程","中建四局"] },
  { name:"朱宇轩", role:"2008届土木工程校友", dept:"土木工程 · 2008届", color:"#1f8a63", bio:"天鉴国际工程管理有限公司董事长/总经理，湖南四顾广告传媒董事长，海南华恒全过程工程咨询执行董事；土木工程学院校友会及邵阳校友会副会长兼秘书长。", tags:["土木工程","工程管理","校友会"] },
  { name:"韦武才", role:"土木工程（工程咨询）校友", dept:"土木工程 · 工程咨询", color:"#0d5c3f", bio:"佛山市众诚工程咨询有限公司总经理，土木工程领域校友代表，专注工程咨询与项目管理。", tags:["土木工程","工程咨询","项目管理"] },
  { name:"冯 明", role:"土木工程学院校友会副秘书长", dept:"土木工程 · 工程管理", color:"#157a52", bio:"中建八局第一建设有限公司商务经理，土木工程学院校友会副秘书长，活跃于校友联络与校企合作。", tags:["土木工程","工程管理","中建八局"] },
...
/* ---------- 校友合作信息发布 ---------- */
const coop = [
  { type:"成果征集", title:"征集教师、校友科技成果与规划设计作品", desc:"汇编《园林与建筑学院成果集(2016-2026)》，面向对象：风景园林、园林、土木、园艺、城乡规划、建筑学等历届校友（含本硕博、进修生及教师）。", foot:"提交截止：纪念活动前 · 详见学院通知" },
  ...
  { type:"平台", title:"校友会小程序上线，联络零距离", desc:"用好“中南林业科技大学校友会”小程序，及时获取活动资讯、活动报名与校友动态。", foot:"中南林业科技大学校友会" },
  { type:"成果转化", title:"创新创业成果专栏征集", desc:"面向校友征集自主知识产权创新产品、技术、服务及成功创业案例，择优编入成果集创新创业专栏。", foot:"学院 · 校友与合作科" },
];

/* ---------- 纪念活动动态 · 学校活动 ---------- */
const schoolEvents = [
  { tag:"纪念活动", title:"办学115周年高质量发展大会暨全球校友大会", desc:"2026年11月8日办学115周年主场活动，诚挚邀请全球校友返校，共迎办学115周年、共谋高质量发展。", date:"2026-11-08", icon:"flag" },
...
const schedule = [
  ...
  { date:"2026-11-08", title:"办学115周年高质量发展大会暨全球校友大会", desc:"办学115周年主场活动 · 诚挚邀请全球校友返校" },
];
